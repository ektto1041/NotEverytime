...
export const AuthSemesterContentItem = ({
  ...
  return (
    <div className='auth-semester-content-item'>
      ...
      <div className='auth-semester-content-column' style={{width: '30%'}}>{lecture.lecture.lectureName}</div>
      <div className='auth-semester-content-column' style={{width: '15%'}}>{lecture.lecture.lectureProfessor}</div>
