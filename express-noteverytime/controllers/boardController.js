...
const getBoard = async (req, res) => {
  ...
  const user_lectures = user_lecture.lecture_detail_id;
  let user_lecture_detail;
  user_lectures.map((lecture) => {
    lecture.lecture_id.equals(lecture_id) ? user_lecture_detail = lecture : ""
  });
  result = { lecture, posts, user_lecture_detail}
